...
function SignificanceBadge({ level }: { level: 'critical' | 'major' }) {
  ...
  return (
    <span
      className={`inline-block rounded border px-2 py-0.5 font-document text-[0.95rem] uppercase tracking-[0.15em] ${styles}`}
    >
      {level}
    </span>
  )
  ...
  return (
    <ScrollReveal delay={index * 120}>
      <div className="group relative border border-smoke/60 bg-ash/60 p-6 transition-colors duration-500 hover:border-blood/40 hover:bg-ash">
        ...
        <div className="mb-4 font-document text-[0.95rem] tracking-[0.1em] text-stone">
          {agency.nameEn}
        </div>

        {/* Description */}
        <p className="mb-4 font-narrative text-[0.95rem] leading-7 text-dust">
          {agency.description}
        </p>
        ...
        <div className="flex flex-wrap gap-2">
          {agency.methods.map((method) => (
            <span
              key={method}
              className="rounded-sm border border-blood-dark/30 bg-blood-dark/10 px-2 py-0.5 font-document text-[0.95rem] tracking-wide text-blood"
            >
              {method}
            </span>
          ))}
  ...
  return (
    <ScrollReveal delay={index * 150}>
      <div className="border-l-2 border-blood-dark/60 bg-ink/80 px-6 py-5">
        ...
        <div className="mb-3 font-document text-[0.95rem] tracking-[0.1em] text-stone">
          {method.nameEn}
        </div>
        <p className="mb-4 font-narrative text-[0.9rem] leading-7 text-dust">
          {method.description}
        </p>
        ...
        <ul className="space-y-2">
          {method.evidence.map((item, i) => (
            <li
              key={i}
              className="flex items-start gap-2 font-document text-[0.95rem] leading-6 text-stone"
            >
    ...
    <ScrollReveal delay={index * 100}>
      <div className="relative border-l-2 border-blood/40 py-4 pl-6">
        ...
        <div className="mb-1 flex flex-wrap items-center gap-3">
          <span className="font-document text-[0.8rem] tracking-[0.1em] text-incense">
            {action.dateROC}
          </span>
          <SignificanceBadge level={action.significance} />
        </div>

        <p className="font-narrative text-[0.95rem] leading-7 text-paper-aged/90">
          {action.description}
        </p>
  ...
  return (
    <ScrollReveal delay={delay}>
      <div className="border border-smoke/40 bg-ink/60 p-6 text-center">
        ...
        <div className="mt-2 font-heading text-[0.8rem] leading-5 tracking-wide text-dust">
          {label}
        </div>
      </div>
    </ScrollReveal>
    ...
    <>
      ...
      <Section id="surveillance-truth" background="void" vignette>
        ...
        <ScrollReveal delay={400}>
          <p className="mt-12 font-document text-[0.95rem] tracking-[0.2em] text-stone">
      ...
      <Section id="surveillance-agencies" background="ink">
        <div className="w-full max-w-[780px]">
          <ScrollReveal>
            <h3 className="mb-2 font-heading text-[0.95rem] uppercase tracking-[0.4em] text-stone">
              SURVEILLANCE APPARATUS
            </h3>
            <h4 className="mb-4 font-narrative text-[clamp(1.3rem,4vw,2rem)] font-bold text-paper-aged">
              四個情治機關，同步監控一個家庭
            </h4>
            <p className="mb-12 max-w-[560px] font-narrative text-[clamp(0.95rem,2vw,1.05rem)] leading-[2] text-dust">
                ...
                <div className="mx-auto">
                  ...
                  >
                    <div className="mb-3 flex flex-wrap items-center gap-3">
                      <span className="font-document text-[0.8rem] tracking-[0.1em] text-smoke">
                        {doc.dateROC}
                      </span>
                      {doc.figureRef && (
                        <span className="font-document text-[0.95rem] tracking-wide text-stone">
                          ({doc.figureRef})
                        </span>
                      )}
                    </div>

                    <p className="font-narrative text-[0.95rem] leading-8 text-smoke">
                      {doc.description}
                    </p>
      ...
      <Section id="surveillance-decryption" background="void" vignette>
        <div className="w-full max-w-[780px]">
          <ScrollReveal>
            <h3 className="mb-2 text-center font-heading text-[0.95rem] uppercase tracking-[0.4em] text-stone">
              INTERACTIVE — 互動體驗
            </h3>
            <h4 className="mb-4 text-center font-narrative text-[clamp(1.3rem,4vw,2rem)] font-bold text-paper-aged">
              監聽解密
            </h4>
            <p className="mb-12 text-center font-narrative text-[clamp(0.95rem,2vw,1.05rem)] leading-[2] text-dust">
        ...
        <div className="w-full max-w-[640px]">
          <ScrollReveal>
            <DocumentPage
              ...
              marginNote="69年2月28日"
            >
              <p className="mb-6 font-narrative text-[0.95rem] leading-8 text-smoke">
                警總保安處組長許覺民證實——
              </p>

              <blockquote className="mb-6 border-l-2 border-blood/60 bg-blood-dark/5 px-5 py-4">
                <p className="font-literary text-[clamp(0.95rem,2vw,1.05rem)] leading-[2] text-smoke">
        ...
        <div className="w-full max-w-[640px]">
          <ScrollReveal>
            <DocumentPage
              ...
              title="監聽錄音帶之矛盾"
            >
              <p className="mb-4 font-narrative text-[0.95rem] leading-8 text-smoke">
                69年3月10日——
              </p>

              <div className="mb-6 space-y-4">
                <div className="border border-smoke/40 bg-void/30 p-4">
                  <div className="mb-1 font-document text-[0.95rem] tracking-[0.15em] text-blood">
                    國安局聲稱
                  </div>
                  <p className="font-literary text-[0.95rem] leading-7 text-smoke">
                ...
                <div className="flex items-center justify-center">
                  <span className="font-document text-[0.8rem] tracking-[0.2em] text-blood">
                    VS.
                  </span>
                </div>

                <div className="border border-smoke/40 bg-void/30 p-4">
                  <div className="mb-1 font-document text-[0.95rem] tracking-[0.15em] text-incense">
                    警總支援小組紀錄
                  </div>
                  <p className="font-literary text-[0.95rem] leading-7 text-smoke">
        ...
        <div className="w-full max-w-[600px]">
          <ScrollReveal>
            <DocumentPage
              ...
              title="第二章結論"
            >
              <p className="font-narrative text-[clamp(0.95rem,2vw,1.05rem)] leading-[2] text-smoke">
