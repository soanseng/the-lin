      ...
      <div className="w-full max-w-[720px]">
        ...
        <ScrollReveal>
          <div className="mb-8 border-t border-smoke pt-16">
            <div className="mb-2 font-document text-[0.85rem] uppercase tracking-[0.4em] text-blood">
              EVIDENCE DESTROYED
            </div>
            <h3 className="mb-4 font-narrative text-[clamp(1.4rem,4vw,2rem)] font-black leading-snug text-paper-aged">
              被消滅的證據
            </h3>
            <p className="mb-12 font-literary text-[clamp(0.95rem,2vw,1.05rem)] leading-8 text-dust">
          ...
          {destroyedEvidence.map((item, index) => (
            <ScrollReveal key={item.id} delay={index * 100}>
              <div className="relative border-l-2 border-blood-dark py-4 pl-6 transition-colors duration-500 hover:border-blood">
                <div className="mb-1 font-document text-[0.85rem] tracking-[0.15em] text-blood-dark">
                  {item.date
                ...
                <p className="font-narrative text-[0.95rem] leading-8 text-dust">
                  {item.description}
                </p>
                <div className="mt-3 font-document text-[0.85rem] tracking-[0.1em] text-stone">
                  {item.source}
                </div>
              </div>
            </ScrollReveal>
        ...
        <ScrollReveal delay={200}>
          <div className="mb-24 border border-smoke bg-void/50 p-8 sm:p-12">
            <div className="mb-6 text-center font-document text-[0.85rem] uppercase tracking-[0.3em] text-stone">
            ...
            <div className="flex flex-col items-center justify-center gap-8 sm:flex-row sm:gap-16">
              <div className="text-center">
                ...
                <div className="mt-2 font-heading text-[0.85rem] text-dust">
                  卷宗原始數量
                </div>
              </div>
        ...
        <ScrollReveal delay={300}>
          <div className="mb-8 text-center">
            ...
            <p className="mt-6 font-document text-[0.85rem] tracking-[0.2em] text-stone">
              ── 促轉會調查報告結論
            </p>
          </div>
        </ScrollReveal>
